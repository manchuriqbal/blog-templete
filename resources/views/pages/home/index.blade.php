        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                    ...
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <span class="bg-blue-100 text-blue-800 px-2 py-1 rounded-md text-xs">Artificial
                                Intelligence</span>
                            <span class="mx-2">•</span>
                        ...
                        <h3 class="text-xl font-bold mb-2 text-gray-800">Getting Started with AI and Machine Learning
                        </h3>
                        <p class="text-gray-600 mb-4">A beginner's guide to understanding and implementing AI and
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Learn the most effective strategies for leveraging cloud computing
                            in your projects.</p>
                        <a href="{{ route('blog.show') }}"
                            class="text-blue-600 font-medium hover:text-blue-800 transition">Read More</a>
                    </div>
    ...
    <div class="container mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <main class="lg:w-2/3">
            ...
            <div class="space-y-8">
                ...
                <article
                    class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition flex flex-col md:flex-row">
                    <img src="https://placehold.co/480x200/png" alt="Low-Code Development"
                        class="md:w-1/3 h-48 md:h-auto object-cover">
                    <div class="p-6 md:w-2/3">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
