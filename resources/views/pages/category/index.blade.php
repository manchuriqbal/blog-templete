    ...
    <div class="container mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
            ...
            <div class="space-y-6">
                ...
                <article
                    ...
                    <div class="p-6 md:w-2/3">
                        ...
                        <p class="text-gray-600 mb-4">Discover the exciting new features and improvements in React 18 and
                            how they can benefit your projects.</p>
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-2">
                ...
                <article
                    ...
                    <div class="p-6 md:w-2/3">
                        ...
                        <p class="text-gray-600 mb-4">Learn how to leverage the powerful new features in TypeScript 5.0 to
                            write more robust and maintainable code.</p>
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-2">
                ...
                <article
                    class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden flex flex-col md:flex-row">
                    <img src="https://placehold.co/480x200/png" alt="Web Performance"
                        class="md:w-1/3 h-48 md:h-auto object-cover">
                    <div class="p-6 md:w-2/3">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                        ...
                        <p class="text-gray-600 mb-4">Comprehensive guide to modern web performance optimization techniques
                ...
                <article
                    class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden flex flex-col md:flex-row">
                    <img src="https://placehold.co/480x200/png" alt="CSS" class="md:w-1/3 h-48 md:h-auto object-cover">
                    <div class="p-6 md:w-2/3">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                        ...
                        <p class="text-gray-600 mb-4">Explore the latest CSS features and techniques that can help you build
                            better interfaces with less code.</p>
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-2">
                ...
                <article
                    class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden flex flex-col md:flex-row">
                    <img src="https://placehold.co/480x200/png" alt="Web Components"
                        class="md:w-1/3 h-48 md:h-auto object-cover">
                    <div class="p-6 md:w-2/3">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                        ...
                        <p class="text-gray-600 mb-4">Are Web Components finally ready for prime time? We examine their
                            current state and future potential.</p>
                        <div class="flex justify-between items-center">
                            <div class="flex space-x-2">
        ...
        <aside class="lg:w-1/3 space-y-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                ...
                <p class="text-gray-600 mb-4">Get the latest web development articles, tutorials, and news delivered to your
                    inbox.</p>
