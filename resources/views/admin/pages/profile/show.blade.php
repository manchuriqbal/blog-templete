            ...
            <div class="flex flex-col md:flex-row items-center md:items-end">
                <div class="avatar-upload mb-4 md:mb-0 md:mr-6">
                    <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Profile"
                        class="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-white shadow-md">
                    <div class="avatar-overlay relative w-24 h-24 md:w-32 md:h-32 flex items-center justify-center">
                        <i class="fas fa-camera text-white text-xl z-10"></i>
                ...
                <div class="mt-4 md:mt-0 md:ml-auto">
                    <a href="{{ route('admin.profile.edit') }}"
                        class="bg-white text-blue-600 border border-blue-600 px-4 py-2 rounded-md hover:bg-blue-50 transition">
        ...
        <main class="lg:w-2/3">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <div class="flex items-center text-sm text-gray-500 mb-2">
                                <span class="bg-blue-100 text-blue-800 px-2 py-1 rounded-md text-xs mr-2">Web
                                    Development</span>
                                <span>Published May 15, 2023</span>
                                <span class="mx-2">•</span>
                                <span><i class="fas fa-eye mr-1"></i> 1,248 views</span>
                            </div>
                            <p class="text-gray-600 mb-3">Explore the latest trends and technologies shaping the future of
                ...
                <div class="border-b border-gray-200 pb-6 mb-6">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-gray-600 mb-3">Discover the exciting new features and improvements in React 18
                ...
                <div class="pb-6">
                    <div class="flex justify-between items-start">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">TypeScript 5.0: Advanced Features Explained
                            </h3>
                            <div class="flex items-center text-sm text-gray-500 mb-2">
                            ...
                            <p class="text-gray-600 mb-3">Learn how to leverage the powerful new features in TypeScript 5.0
                                to write more robust and maintainable code.</p>
                        </div>
                        <div class="flex space-x-2">
                            <button class="text-gray-500 hover:text-blue-600 p-2 rounded-full hover:bg-gray-100">
                                <i class="fas fa-edit"></i>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-4">
                    <div class="border-b border-gray-200 pb-4">
                        <p class="text-sm text-gray-600 mb-1">On <a href="#" class="text-blue-600 hover:underline">The
                                Future of Web Development</a></p>
                        <p class="text-gray-700 mb-2">"Great article! WebAssembly is really changing the game."</p>
                        <p class="text-xs text-gray-500">2 days ago</p>
                    </div>
                    <div class="border-b border-gray-200 pb-4">
                        <p class="text-sm text-gray-600 mb-1">On <a href="#" class="text-blue-600 hover:underline">React 18
                                Features</a></p>
                        <p class="text-gray-700 mb-2">"The new concurrent rendering is a game changer for our app."</p>
                        <p class="text-xs text-gray-500">1 week ago</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1">On <a href="#"
                                class="text-blue-600 hover:underline">TypeScript 5.0</a></p>
